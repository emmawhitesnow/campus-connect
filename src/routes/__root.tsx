...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Orbit helps college students maintain friendships, discover clubs and events, and find belonging on campus." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Orbit — Stay close on campus" },
      { name: "twitter:description", content: "Orbit helps college students maintain friendships, discover clubs and events, and find belonging on campus." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/06f8c392-e50b-49b1-94b9-8a4fb6111044/id-preview-646c03b0--3ffbb823-311a-4122-b35c-0de596cf1200.lovable.app-1780032130959.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/06f8c392-e50b-49b1-94b9-8a4fb6111044/id-preview-646c03b0--3ffbb823-311a-4122-b35c-0de596cf1200.lovable.app-1780032130959.png" },
    ],
    links: [
